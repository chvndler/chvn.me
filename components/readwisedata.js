          ...
          <div className="flex flex-col mb-2 cursor-pointer">
            ...
            <div className="flex flex-row items-center transition-all ease-in-out 100ms group">
              <p
                ...
                className="text-tertiary dark:text-darkTertiary"
              >
                {`${singleHighlight ? `Read ${highlightsNum} highlight` : `Read ${highlightsNum} highlights`}`}
              </p>
              <div
                onClick={() => {
                  setOpen(!open);
                }}
                className={open ? 'ml-1 mt-0.5 transition-all 200ms ease-in-out transform rotate-90' : 'ml-1 mt-0.5'}
              >
                <Chevron />
              </div>
            </div>
            ...
            return (
              ...
              >
                ...
                <p
                  id={highlightID}
                  name={highlightID}
                  className={`${individualHighlight ? 'bg-code dark:bg-darkCode' : ' '}`}
                >
                  {text}
                </p>
              </div>
