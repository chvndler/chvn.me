...
const Welcome = () => {
  return (
    <Page title="" description="">
      ...
      <h5>Connect.</h5>
      <p className="links">
        <Link className="arena" href="https://www.are.na/chvndler-ch" target="_blank" rel="norefferer">
          Are.na
        </Link>{' '}
        <Link className="twitter" href="https://twitter.com/chv_ndler" target="_blank" rel="norefferer">
          Twitter
        </Link>{' '}
        <Link className="github" href="https://github.com/chvndler" target="_blank" rel="norefferer">
          GitHub
        </Link>{' '}
        <Link className="instagram" href="https://www.instagram.com/chv.ndler/" target="_blank" rel="norefferer">
          Instagram
        </Link>
      </p>
