        ...
        <div className="grid max-w-full gap-16 auto-rows-auto">
          <div>
            <p className="mt-8 md:mt-4">
              I'm currently shaping the mobile apps at GitHub and crafting app icons for a wide variety of clients. I
              focus on fit and finish to solve problems and create seamless experiences. If you'd like to work with me
              on an icon, please{' '}
              <a
          ...
          <Section title="Notes">
            <Link href="/notes" passhref>
              <a className=" text-tertiary dark:text-darkTertiary group" target="_blank" rel="noopener noreferrer">
                Explore
                <ArrowExternal />
              </a>
            </Link>
          ...
          <Section title="Select Icons">
            ...
            <div className="grid grid-cols-1 gap-x-4 gap-y-6 sm:grid-cols-2">
              <Icon src={holo} title="Holo" subtitle="GitHub" link="https://github.com/mobile" />
              <Icon
                src={vscode}
                title="VS Code"
                subtitle="Personal"
              ...
              <Icon src={g1} title="G1 Chip" subtitle="GitHub" width="400" link="https://github.com/mobile" />
              <Icon src={camo} title="Camo" subtitle="Reincubate" width="400" link="https://reincubate.com/camo/" />
              <div className="max-w-full sm:col-span-2">
                <Icon src={craft} title="Craft" subtitle="Craft Docs" width="800" link="https://www.craft.do" />
              </div>
              <Icon
                src={obsidian}
                title="Obsidian"
              ...
              />
              <Icon src={earlybird} title="Earlybird" subtitle="GitHub" width="800" link="https://github.com/mobile" />
              ...
              <Icon src={stocketa} title="Stocketa" subtitle="Stocketa" width="400" link="https://stocketa.com" />
              <Icon src={reflect} title="Reflect" subtitle="Reflect Notes" width="400" link="https://reflect.app" />
