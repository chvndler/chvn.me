...
export const styledAlternateButton = css({
  all: 'unset',
  display: 'inline-flex',
  alignItems: 'center',
...
export const DefaultButton = styled(DEFAULT_TAG, button);
export const AlternateButton = styled(DEFAULT_TAG, styledAlternateButton);
