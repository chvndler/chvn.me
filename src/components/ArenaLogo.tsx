...
export const ArenaLogoIcon = React.forwardRef<SVGSVGElement, IconProps>(({ color = 'currentColor', ...props }, forwardedRef) => {
  return (
    <svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg" {...props} ref={forwardedRef}>
      <path
        d="M14.7,5.5c0,0,0,0.1-0.1,0.1c-0.5,0.4-1,0.8-1.5,1.1c-0.2,0.2-0.5,0.4-0.7,0.6c-0.2,0.1-0.2,0.3,0,0.4
