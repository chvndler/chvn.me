...
import { IconProps } from '@/types/logos';

export const SpotifyLogo = React.forwardRef<SVGSVGElement, IconProps>(({ color = '#1ed760', ...props }, forwardedRef) => {
  return (
    <svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg" {...props} ref={forwardedRef}>
      <path
