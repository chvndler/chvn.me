...
export const MasterLogo = React.forwardRef<SVGSVGElement, IconProps>(({ color = '$chvn5', ...props }, forwardedRef) => {
  return (
    <>
      <Flex css={{ align: 'center', alignItems: 'center' }}>
        ...
        c-0.1,0.1-0.2,0.2-0.2,0.4c-0.1,0.2-0.1,0.4-0.1,0.7c0,0.3,0,0.7,0,1.1C34.1,11.8,34.1,12.1,34.1,12.4z"
          />
          <path fill={color} fillRule="evenodd" clipRule="evenodd" d="M41.6,4.7v10.7h-2.7V4.7H41.6z" />
          <path
            fill={color}
            fillRule="evenodd"
            clipRule="evenodd"
